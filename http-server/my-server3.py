...
with socketserver.TCPServer(("", PORT), Handler) as httpd:
    # print ("Python3: servable/my-serve3.sh using servable/my-server3.py serving at port", PORT, " in directory ", DIRECTORY)
    print ("Python3: servable/my-serve3.sh using http-experiments/my-server3.py serving at port", PORT)
    httpd.serve_forever()
